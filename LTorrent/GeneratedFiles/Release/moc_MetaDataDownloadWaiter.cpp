/****************************************************************************
** Meta object code from reading C++ file 'MetaDataDownloadWaiter.h'
**
...
#error "The header file 'MetaDataDownloadWaiter.h' doesn't include <QObject>."
...
static const uint qt_meta_data_MetaDataDownloadWaiter[] = {
...
void MetaDataDownloadWaiter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->DownloadCompleted((*reinterpret_cast< openmagnet_info(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject &MetaDataDownloadWaiter::getStaticMetaObject() { return staticMetaObject; }
