...
void MultipleDTDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->MountSelectedFILE(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject MultipleDTDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_MultipleDTDialog,
      qt_meta_data_MultipleDTDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MultipleDTDialog::getStaticMetaObject() { return staticMetaObject; }
