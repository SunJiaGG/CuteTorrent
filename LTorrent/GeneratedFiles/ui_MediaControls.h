...
**
** Created: Wed 22. May 15:00:29 2013
...
public:
    ...
    void setupUi(QWidget *MediaControls)
    {
        ...
        MediaControls->resize(360, 66);
        MediaControls->setStyleSheet(QString::fromUtf8("background-color:\"transparent\";\n"
"border-color:\"transparent\";"));
        volumeSlider = new Phonon::VolumeSlider(MediaControls);
        volumeSlider->setObjectName(QString::fromUtf8("volumeSlider"));
        volumeSlider->setGeometry(QRect(14, 10, 100, 24));
...
"border-color:\"transparent\""));
        ...
        seekSlider->setGeometry(QRect(60, 40, 239, 22));
        seekSlider->setIconVisible(true);
